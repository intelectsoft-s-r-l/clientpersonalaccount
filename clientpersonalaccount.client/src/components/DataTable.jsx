        ...
        <>
            ...
            <div className="bg-white rounded-3xl">
                ...
                <div className="p-4 overflow-x-auto w-full">
                    <div className="flex justify-end p-0 mb-2 sm:p-4">
                        <input
                            type="text"
                    ...
                    {/* Таблица */}
                    <div className="rounded-b-3xl border border-[#dbdbdb] overflow-x-auto overflow-y-hidden">
                        <table className={`w-full table-fixed border-collapse ${tableClassName}`}>
                            <thead>
                                <tr className="bg-gray-100">
                                    ...
                                    {onDeleteRow && <th className="sticky right-0 dark:bg-gray-800 z-20" style={{ width: "3%", whiteSpace: "nowrap" }}></th>}
                                </tr>
                            </thead>
                                                ...
                                                {columns.map((col) => {
                                                    ...
                                                    if (isEditing) {
                                                        ...
                                                        if (col.options) {
                                                            ...
                                                            if (typeof col.options === "function") {
                                                                options = col.options(row, extraData) ?? [];
                                                            ...
                                                            return (
                                                                ...
                                                                >
                                                                    ...
                                                                    <input
                                                                        type="text"
                                                                        placeholder="Поиск..."
                                                                        className="w-full mb-1 p-1 border border-gray-300 rounded dark:bg-gray-700 dark:text-white"
                                                                        value={selectSearch}
                                                    ...
                                                    return (
                                                        <td
                                                            ...
                                                            className={`p-2 border border-[#dbdbdb] text-sm text-gray-900 ${getAlignment(
                                                                col
                                                            )} overflow-hidden whitespace-nowrap text-ellipsis dark:bg-gray-800 dark:text-white`}
                                                            onClick={() =>
                        ...
                        {totalPages > 1 && (
                            <div className="flex flex-wrap justify-center items-center gap-1 sm:gap-2 p-2 sm:p-4">
                                ...
                                {currentPage != 1 && currentPage != 2 && totalPages > 1 && (
                                    <>
                                        <button
                        ...
                        <div className="flex justify-start items-center gap-2 p-2 sm:p-4">
